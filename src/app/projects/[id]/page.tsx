  ...
  return (
    <div className="min-h-screen text-white py-12 px-4 lg:px-8">
      <div className="container mx-auto max-w-7xl">
        ...
        <Link
          href="/#projects"
          className="inline-flex items-center gap-2 text-white hover:text-blue-400 transition-colors mb-8 group font-medium"
        >
          ...
          <div className="relative z-10 p-8 lg:p-16 flex flex-col lg:flex-row gap-12 items-center">
            ...
            <div className="w-full lg:w-1/2 flex flex-col gap-6">
              ...
              <div className="flex flex-wrap gap-3">
                <Badge className="bg-blue-500/10 text-blue-400 hover:bg-black border-blue-500/20 px-3 py-1 font-bold tracking-wider">
                  {project.date || "2024"}
                </Badge>

                <Badge className="bg-blue-950/20 text-blue-300 hover:bg-black border-blue-900/30 px-3 py-1 font-bold tracking-wider">
                  {project.role}
                </Badge>
              </div>
              ...
              <div className="flex flex-wrap gap-4 mt-4">
                ...
                {project.code && (
                  <Link href={project.code} target="_blank">
                    <Button
                      variant="outline"
                      className="border-white/10 bg-white/5 hover:bg-blue-950/20 hover:text-blue-400 hover:border-blue-500/30 text-white px-8 py-6 text-lg rounded-xl transition-all hover:scale-105 active:scale-95 flex gap-2 font-bold uppercase tracking-widest"
                    >
